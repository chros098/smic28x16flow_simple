// E906 tier-50k stubs (GDS-only flow). Constant-zero outputs.
...
module pa_iu_mul(
  ...
  assign mul_dp_ex1_cmplt = 1'b0;
  assign mul_dp_ex1_cmplt_dp = 1'b0;
  assign mul_dp_ex2_inst_vld = 1'b0;
  assign mul_dp_ex2_rslt0 = 32'b0;
  assign mul_dp_ex2_rslt0_vld = 1'b0;
endmodule
...
module pa_iu_div(
  ...
  assign div_ctrl_itering = 1'b0;
  assign div_dp_ex1_cmplt = 1'b0;
  assign div_dp_ex1_cmplt_dp = 1'b0;
  assign div_dp_ex1_fwd_data = 32'b0;
  assign div_dp_ex1_fwd_vld = 1'b0;
  assign div_dp_ex1_stall = 1'b0;
  assign div_dp_ex2_dst_preg = 6'b0;
  assign div_dp_ex2_rslt = 32'b0;
  assign div_dp_ex2_rslt_vld = 1'b0;
  assign div_iu_debug_info = 5'b0;
endmodule
...
module pa_iu_bju(
  ...
  assign bju_dp_ex1_cmplt_dp = 1'b0;
  assign bju_dp_ex1_rslt = 32'b0;
  assign bju_dp_ex1_rslt_vld = 1'b0;
  assign bju_dp_ex1_stall = 1'b0;
  assign bju_dp_no_op = 1'b0;
  assign bju_iu_debug_info = 4'b0;
  assign iu_cp0_ex1_borrow_expt_pc = 32'b0;
  assign iu_ex1_cur_pc = 32'b0;
  assign iu_hpcp_inst_bht_mispred = 1'b0;
  assign iu_hpcp_inst_condbr = 1'b0;
  assign iu_hpcp_inst_condbr_gate = 1'b0;
  assign iu_idu_bju_global_stall = 1'b0;
  assign iu_idu_bju_stall = 1'b0;
  assign iu_ifu_bht_cur_pc = 32'b0;
  assign iu_ifu_bht_mispred = 1'b0;
  assign iu_ifu_bht_mispred_gate = 1'b0;
  assign iu_ifu_bht_pred = 2'b0;
  assign iu_ifu_bht_taken = 1'b0;
  assign iu_ifu_br_vld = 1'b0;
  assign iu_ifu_br_vld_gate = 1'b0;
  assign iu_ifu_ind_link_vld = 1'b0;
  assign iu_ifu_link_vld = 1'b0;
  assign iu_ifu_link_vld_gate = 1'b0;
  assign iu_ifu_pc_mispred = 1'b0;
  assign iu_ifu_pc_mispred_gate = 1'b0;
  assign iu_ifu_ret_vld = 1'b0;
  assign iu_ifu_ret_vld_gate = 1'b0;
  assign iu_ifu_tar_pc = 32'b0;
  assign iu_ifu_tar_pc_vld = 1'b0;
  assign iu_ifu_tar_pc_vld_gate = 1'b0;
  assign iu_rtu_ex1_bju_branch_inst = 1'b0;
  assign iu_rtu_ex1_bju_cmplt = 1'b0;
  assign iu_rtu_ex1_bju_cmplt_dp = 1'b0;
  assign iu_rtu_ex1_bju_cur_pc = 31'b0;
  assign iu_rtu_ex1_bju_inst_len = 1'b0;
  assign iu_rtu_ex1_bju_inst_vld = 1'b0;
  assign iu_rtu_ex1_bju_split_inst = 1'b0;
  assign iu_rtu_ex1_next_pc = 31'b0;
  assign iu_rtu_ex2_bju_flush = 1'b0;
  assign iu_rtu_ex2_bju_next_pc = 31'b0;
  assign iu_rtu_ex2_bju_next_pc_vld = 1'b0;
  assign iu_yy_xx_cancel = 1'b0;
endmodule
...
module pa_iu_alu(
  ...
  assign alu_dp_ex1_cmplt = 1'b0;
  assign alu_dp_ex1_cmplt_dp = 1'b0;
  assign alu_dp_ex1_fwd_vld = 1'b0;
  assign alu_dp_ex1_rslt = 32'b0;
endmodule
